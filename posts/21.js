...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.9 · 리뷰 2,655건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.5 · 리뷰 1,009건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">청담동 44-11에 위치한 한식·고기 매장입니다. 평점 4.5·리뷰 1,009건이 누적되었고, 한우곱창·대창·막창 200g을 각각 22,000원에 단일가로 묶어 운영하는 곱창 정통 매장입니다. 한가람모듬 45,000원으로 4~6인 회식 자리에 매칭이 좋고, 한돈김치찌개 9,000원·봄동 비빔밥 10,000원 같은 단품으로 점심 동선도 함께 잡습니다. 10:00 영업 시작이라 점심·저녁 모두 가능하고, "회식·기분 좋음" 평가가 함께 묶여 있어 부서 회식·동기 모임에 매칭이 좋습니다. 청담동 위치라 삼성역 도보권은 아니지만 차량·택시로 5~10분 거리입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
