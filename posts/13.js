const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: "<p>영통구청·매탄동 근처에서 회식·단체 괜찮은 곳을 찾고 계시는 분들을 위해 준비하였습니다. 7곳을 추려서 가격과 메뉴까지 상세하게 정리하였습니다.</p><p>평균 평점 4.4점입니다. 가격대는 8,000원부터 시작하며, 2026년 5월 기준이며, 룸·단체석·인당 예산·주차을 위주로 비교하였습니다.</p><p>소개 순서: 또또지짐이, 서재명가부대찌개, 금강산화로구이, 기막힌족발 본점, 양심소 매탄점.</p>",
    },
    {
      type: 'toc',
    },
    ...
    {
      type: 'body',
      html: "<p>공간이 괜찮은 편이라 눈에 들어오는 곳입니다. <a href=\"/samsungElectronics/yeongtongGu/restaurant/서재명가부대찌개\">서재명가부대찌개</a>.</p><p>점심시간에는 웨이팅이 있는 편이니 일찍 방문하시는 것을 추천드립니다. 주차가 가능합니다. 예약이 가능합니다. 단체석이 마련되어 있습니다.</p><p>277건 리뷰에 4.3점이면 동네 단골 식당 정도로 보면 됩니다.</p><p><a href=\"/samsungElectronics/yeongtongGu/restaurant/서재명가부대찌개\" style=\"color:var(--primary)\">→ 서재명가부대찌개 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "금강산화로구이",
    ...
    {
      type: 'body',
      html: "<p><a href=\"/samsungElectronics/yeongtongGu/restaurant/낙지의품격\">낙지의품격</a>. 평점 4.6점, 리뷰 7건 정도 있습니다.</p><p>가격대는 10,000~20,000원입니다.</p><p>점심 시간에는 웨이팅이 있을 수 있습니다. 단체석이나 룸이 마련되어 있습니다. 예약이 가능합니다.</p><p>4.6점·리뷰 7건. 방문자 평이 비교적 일관되게 좋은 편입니다.</p><p><a href=\"/samsungElectronics/yeongtongGu/restaurant/낙지의품격\" style=\"color:var(--primary)\">→ 낙지의품격 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "compare",
    ...
    {
      type: 'body',
      html: "<ul><li><strong>가성비 우선:</strong> 금강산화로구이, 용갈이뷔페 — 합리적인 가격에 만족스러운 식사가 가능합니다.</li><li><strong>분위기 중시:</strong> 또또지짐이, 기막힌족발 본점 — 데이트나 특별한 날에 추천합니다.</li><li><strong>평점 최고:</strong> 낙지의품격 (평점 4.6점) — 방문자 평가가 가장 높습니다.</li><li><strong>리뷰 최다:</strong> 또또지짐이 (리뷰 294건) — 가장 많은 방문자가 검증한 식당입니다.</li></ul>",
    },
    {
      type: 'h2',
      id: "tips",
