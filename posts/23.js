const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: "<p>잠실 데이트 맛집을 검색하면 너무 많은 결과가 나옵니다. 1149곳의 데이터에서 실제로 방문할 만한 5곳만 선별하였습니다.</p><p>평균 평점 5.0점입니다. 가격대는 3,000원부터 시작하며, 2026년 5월 기준이며, 분위기·코스 구성·예약 여부·뷰을 위주로 비교하였습니다.</p><p>소개 순서: 조조모모, 요즈음, 라코즈, 돈담 잠실새내본점, 연정민 소금구이.</p>",
    },
    {
      type: 'toc',
    },
    ...
    {
      type: 'body',
      html: "<ul><li>조조모모은 점심 피크 시간(12시~12시 30분)에 대기가 있을 수 있습니다. 11시 50분 이전에 방문하시는 것을 추천드립니다.</li><li>조조모모, 요즈음은 사전에 예약하고 방문하시는 것이 좋습니다. 특히 주말 저녁에는 예약이 필수입니다.</li><li>주차 가능한 곳: 라코즈, 돈담 잠실새내본점, 연정민 소금구이.</li><li>조조모모, 요즈음 등은 전용 주차장이 없습니다. 대중교통 이용을 권장드립니다.</li><li>데이트를 계획하신다면 예약은 필수입니다. 금요일·토요일 저녁은 최소 3일 전에 예약하시기 바랍니다.</li></ul>",
    },
    {
      type: 'cta',
