const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: "<p>망포역·삼성전자 근처에서 가성비 괜찮은 곳을 찾고 계시는 분들을 위해 준비하였습니다. 5곳을 추려서 가격과 메뉴까지 상세하게 정리하였습니다.</p><p>평균 평점 4.3점입니다. 가격대는 8,000원부터 시작하며, 2026년 5월 기준이며, 1인 가격·양·혼밥 가능 여부을 위주로 비교하였습니다.</p><p>소개 순서: 청담칼국수, 서천교동짬뽕, 행복한김밥, 생고기김치찌개, 한마음정육식당 영통점.</p>",
    },
    {
      type: 'toc',
    },
    ...
    {
      type: 'body',
      html: "<p>망포 일대 가성비 식당 가운데 평점·리뷰·메뉴 데이터가 모두 확인된 곳을 추렸습니다. 전체 345곳을 지역·카테고리·평점 기준으로 필터링한 뒤, 평점 4.1점 이상이면서 방문자 리뷰가 일정 수 이상 누적된 5곳을 선별했습니다.</p><p>이 글에 실린 식당들의 평균 평점은 <strong>4.3점</strong>이며, 누적 리뷰 수는 약 <strong>285건</strong>입니다. 1인 9,600원~18,400원 사이가 일반적이며, 1인 가격·양·혼밥 가능 여부을(를) 비교 기준으로 삼았습니다.</p><p>리뷰·평점 정보는 2026년 5월 기준이며, 영업시간·가격·메뉴 구성은 매장 사정에 따라 달라질 수 있어 방문 전에 한 번 더 확인하시는 편이 좋습니다.</p>",
    },
    {
      type: 'h2',
      id: "청담칼국수",
    ...
    {
      type: 'body',
      html: "<p><a href=\"/samsungElectronics/mangpo/restaurant/행복한김밥\">행복한김밥</a>은 분식 카테고리에 속하는 식당으로입니다. 평점 4.1점, 리뷰 72건 수준이라 표본은 작지만 평가가 좋은 편입니다.</p><p>1인 기준 가격대는 10,000원에서 20,000원 사이로 형성되어 있습니다. 이 카테고리 평균 시작가(9,600원)와 비슷한 수준입니다.</p><p>점심 시간 회전이 빠른 편이라 직장인 점심으로 적합합니다 가격 대비 양·구성이 합리적이라는 평이 많습니다</p><p style=\"font-size:.85rem;color:var(--muted)\">📌 영업시간 6:00 AM~8:00 PM · 위치 서천동 286-3번지</p><div style=\"margin:18px 0 8px;text-align:center\"><a href=\"/samsungElectronics/mangpo/restaurant/행복한김밥\" style=\"display:inline-flex;align-items:center;gap:8px;padding:13px 26px;border-radius:12px;background:linear-gradient(135deg,#FF6B6B 0%,#FFD93D 100%);color:#1a1a22;font-weight:800;font-size:.92rem;text-decoration:none;box-shadow:0 4px 14px rgba(255,107,107,.35);transition:transform .15s\">🍽 행복한김밥 메뉴·리뷰·위치 보기 →</a></div>",
    },
    {
      type: 'h2',
      id: "생고기김치찌개",
      text: "생고기김치찌개 — 고기구이 전문점",
      gradientStyle: { from: '#667EEA', to: '#764BA2' },
    },
    {
      type: 'body',
      html: "<p><a href=\"/samsungElectronics/mangpo/restaurant/생고기김치찌개\">생고기김치찌개</a>는 고기구이 카테고리에 속하는 식당으로입니다. 평점 4.5점, 리뷰 29건 수준이라 표본은 작지만 평가가 좋은 편입니다.</p><p>1인 기준 가격대는 10,000원에서 20,000원 사이로 형성되어 있습니다. 이 카테고리 평균 시작가(9,600원)와 비슷한 수준입니다.</p><p>단체석·룸이 있어 회식이나 모임 자리로도 가능합니다 분위기가 무난한 편이라 가벼운 데이트로도 무리가 없습니다</p><p style=\"font-size:.85rem;color:var(--muted)\">📌 영업시간 영업시간 확인 필요 · 위치 신원로 177</p><div style=\"margin:18px 0 8px;text-align:center\"><a href=\"/samsungElectronics/mangpo/restaurant/생고기김치찌개\" style=\"display:inline-flex;align-items:center;gap:8px;padding:13px 26px;border-radius:12px;background:linear-gradient(135deg,#FF6B6B 0%,#FFD93D 100%);color:#1a1a22;font-weight:800;font-size:.92rem;text-decoration:none;box-shadow:0 4px 14px rgba(255,107,107,.35);transition:transform .15s\">🍽 생고기김치찌개 메뉴·리뷰·위치 보기 →</a></div>",
    },
    {
      type: 'h2',
      id: "한마음정육식당-영통점",
