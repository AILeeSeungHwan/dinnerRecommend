const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: "<div style=\"margin:16px 0\"><details open style=\"margin:8px 0;padding:10px 14px;background:var(--surface);border:1px solid var(--border);border-radius:10px\"><summary style=\"font-weight:700;cursor:pointer;color:var(--text)\">Q. 망포에서 가성비 어디가 평점이 가장 높나요?</summary><p style=\"margin:10px 0 0;color:var(--muted);line-height:1.7\">A. 이 글에 정리된 5곳 중에서는 서천교동짬뽕이(가) 평점 4.6점으로 가장 높습니다. 리뷰는 26건이 누적된 상태이며, 같은 카테고리 평균(약 4.1점) 대비 안정적인 평가입니다.</p></details><details open style=\"margin:8px 0;padding:10px 14px;background:var(--surface);border:1px solid var(--border);border-radius:10px\"><summary style=\"font-weight:700;cursor:pointer;color:var(--text)\">Q. 망포 가성비 한 끼는 보통 얼마인가요?</summary><p style=\"margin:10px 0 0;color:var(--muted);line-height:1.7\">A. 이 글의 5곳 평균을 보면 1인 시작가는 8,000원부터 형성되어 있습니다. 가성비 위주라면 청담칼국수 같은 곳이 합리적이며, 코스 위주면 인당 3만~5만원대를 잡아두는 편이 안전합니다.</p></details><details open style=\"margin:8px 0;padding:10px 14px;background:var(--surface);border:1px solid var(--border);border-radius:10px\"><summary style=\"font-weight:700;cursor:pointer;color:var(--text)\">Q. 예약은 필요한가요?</summary><p style=\"margin:10px 0 0;color:var(--muted);line-height:1.7\">A. 주말 저녁 시간대에는 예약이 안전합니다. 이 글의 5곳 중 예약 가능한 곳은 대부분 매장에 직접 확인이 필요합니다. 평일 점심은 보통 예약 없이도 자리가 있는 편입니다.</p></details><details open style=\"margin:8px 0;padding:10px 14px;background:var(--surface);border:1px solid var(--border);border-radius:10px\"><summary style=\"font-weight:700;cursor:pointer;color:var(--text)\">Q. 주차는 가능한가요?</summary><p style=\"margin:10px 0 0;color:var(--muted);line-height:1.7\">A. 대부분 별도 주차장이 없는 편이라 망포은 대중교통 접근이 더 편합니다. 인근 공영주차장이나 빌딩 주차장을 활용하시는 분들이 많습니다.</p></details><details open style=\"margin:8px 0;padding:10px 14px;background:var(--surface);border:1px solid var(--border);border-radius:10px\"><summary style=\"font-weight:700;cursor:pointer;color:var(--text)\">Q. 혼밥하기 좋은 곳도 있나요?</summary><p style=\"margin:10px 0 0;color:var(--muted);line-height:1.7\">A. 식당 상세 페이지의 \"혼밥가능\" 태그가 있는 곳을 확인하시면 됩니다. 평일 점심 시간대에는 1인 식사도 자연스럽게 받는 곳이 많고, 단가는 8,000원 안팎이 무난합니다.</p></details></div>",
    },
    {
      type: 'cta',
