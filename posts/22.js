const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: "<p>(런치) 봄과 장 코스(75,000원)이 대표 메뉴인 <a href=\"/pangyo/restaurant/꿰다 판교아브뉴프랑점\">꿰다 판교아브뉴프랑점</a>. (디너) 봄과 장 코스, 감자 냉수프 같은 메뉴도 있다.</p><p>그 외에 보리 샐러드, 찐 전복과 가지도 있다.</p><p>주차는 된다. 예약 가능. 단체석 가능.</p><p>평점 4.9점이면 이 동네에서 상위권이다. 리뷰 244건. 인당 7만원대 예산이면 된다.</p><p><a href=\"/pangyo/restaurant/꿰다 판교아브뉴프랑점\" style=\"color:var(--primary)\">→ 꿰다 판교아브뉴프랑점 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "우화",
