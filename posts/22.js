const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: "<p>판교역·테크노밸리·백현동 근처에서 회식·단체 괜찮은 곳을 찾고 계시는 분들을 위해 준비하였습니다. 5곳을 추려서 가격과 메뉴까지 상세하게 정리하였습니다.</p><p>평균 평점 4.9점입니다. 가격대는 12,000원부터 시작하며, 2026년 5월 기준이며, 룸·단체석·인당 예산·주차을 위주로 비교하였습니다.</p><p>소개 순서: 스시소라 판교점, 꿰다 판교아브뉴프랑점, 우화, 바차 판교점, 심양 판교점.</p>",
    },
    {
      type: 'toc',
    },
    ...
    {
      type: 'body',
      html: "<p>판교 전체 902곳에서 회식·단체 카테고리에 해당하는 식당을 선별하였습니다. 평점 4.8점 이상, 룸·단체석·인당 예산·주차 기준으로 비교하였습니다. 2026년 5월 데이터 기준이므로, 폐업이나 가격 변동이 있을 수 있으니 방문 전에 반드시 확인하시기 바랍니다.</p>",
    },
    {
      type: 'h2',
      id: "스시소라-판교점",
    ...
    {
      type: 'body',
      html: "<ul><li>우화은 점심 피크 시간(12시~12시 30분)에 대기가 있을 수 있습니다. 11시 50분 이전에 방문하시는 것을 추천드립니다.</li><li>꿰다 판교아브뉴프랑점, 우화은 사전에 예약하고 방문하시는 것이 좋습니다. 특히 주말 저녁에는 예약이 필수입니다.</li><li>주차 가능한 곳: 스시소라 판교점, 꿰다 판교아브뉴프랑점, 바차 판교점.</li><li>우화 등은 전용 주차장이 없습니다. 대중교통 이용을 권장드립니다.</li><li>회식의 경우 인원 확정 후 2~3일 전에 예약하시는 것이 좋습니다. 룸이 필요하시다면 일주일 전에 미리 잡으시기 바랍니다.</li></ul>",
    },
    {
      type: 'cta',
