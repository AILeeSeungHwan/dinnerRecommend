const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: "<p>판교에서 회식·단체 식당을 찾고 계신다면, 이 글 하나로 정리해 드리겠습니다. 총 902곳 중 회식·단체 6곳을 엄선하여 비교하였습니다.</p><p>평균 평점 4.8점입니다. 가격대는 12,000원부터 시작하며, 2026년 5월 기준이며, 룸·단체석·인당 예산·주차을 위주로 비교하였습니다.</p><p>소개 순서: 불고기 온소반, 판교맛집 왕징양다리양꼬치 판교점, 늘푸른 생선구이, 우화, 루프일레븐(ROOF 11).</p>",
    },
    {
      type: 'toc',
    },
