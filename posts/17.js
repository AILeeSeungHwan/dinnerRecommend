...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.9 · 리뷰 378건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px"><strong>본 가이드 5곳 중 평점 1순위(★ 4.9)</strong>인 중식당입니다. 삼평동 684 <strong>판교엠타워 1층</strong>에 자리잡고 있어 판교역 도보·차량 접근이 모두 가능하며, "재료 신선 · 서비스 · 맛있다" 키워드가 후기에 누적되어 있습니다. 짜장·짬뽕 단품부터 코스까지 라인업이 넓은 중식당이며, 평일 점심 회식·동료 식사 시나리오에 자주 묶이는 매장입니다. 평점 4.9는 본 가이드 평균(4.2) 대비 큰 폭으로 앞서는 수치라, 짜장·짬뽕 한 그릇이라도 첫 후보로 검토할 수 있는 옵션입니다.</p>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">서현동 269-4 2층 206호, 분당선 서현역 도보 동선의 마라탕 매장입니다. <strong>평점 4.3 · 리뷰 208건</strong>으로 본 가이드 5곳 중 마라탕 카테고리에서 표본·평점 모두 1순위이며, "서비스 · 맛있다" 키워드가 후기에 매칭됩니다. 마라탕·마라샹궈 단품에 꿔바로우·만두 사이드 조합이 표준 주문 패턴이며, 1인 1만원선 점심 회전형 한 끼에 단가가 명확합니다. 판교역에서는 분당선 두 정거장 거리이지만, 서현역 직장인·회식 점심에 자주 활용되는 매장입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.0 · 리뷰 842건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">백현동 580-4 동선의 손짬뽕 전문 매장입니다. <strong>리뷰 842건</strong>으로 본 가이드 5곳 중 표본 절대 1위이며, 평점 4.0은 본 가이드 평균보다 약간 낮지만 800건이 넘는 표본이 평균값을 안정시켜 줍니다. 백현동 직장인 점심·차량 동선 회식이 자주 누적되는 짬뽕 단품 매장으로, 점심 회전이 빠른 식당이라 12시 피크에도 자리 잡기 수월합니다. "서비스" 키워드가 후기에 매칭되어 있어 매장 응대도 안정적입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.0 · 리뷰 586건</span>
<span style="background:#E1F5EE;color:#04342C;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">💰 짬뽕 단품 가격대</span>
<span style="background:#EEF2FF;color:#312E81;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">✓ 인허가 검증</span>
</div>
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">판교동 621-2번길 8-7, 청계산 등산로 동선의 수타면 짬뽕 매장입니다. <strong>리뷰 586건</strong>이 누적되어 본 가이드 5곳 중 표본 2위 식당이며, 평점 4.0은 본 평균보다 약간 낮지만 표본 크기가 평균값을 안정시켜 줍니다. 수타면 짬뽕 단품이 시그니처이며, 청계산 산행 후 점심·차량 식사 시나리오에 자주 누적됩니다. 백현동·아브뉴프랑 동선과 떨어진 판교동 매장이라 동선 분산 차원에서도 의미가 있고, 차량 이용자 위주 매장입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
