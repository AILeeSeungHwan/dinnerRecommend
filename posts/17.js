...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.2 · 리뷰 1,577건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.1 · 리뷰 1,784건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.3 · 리뷰 851건</span>
<span style="background:#E1F5EE;color:#04342C;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">💰 짬뽕 단품 가격대</span>
<span style="background:#EEF2FF;color:#312E81;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">✓ 인허가 검증</span>
</div>
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">판교동 621-2번길 8-7, 청계산 등산로 동선의 수타면 짬뽕 매장입니다. <strong>리뷰 851건</strong>이 누적되어 본 가이드 5곳 중 표본 2위 식당이며, 평점 4.0은 본 평균보다 약간 낮지만 표본 크기가 평균값을 안정시켜 줍니다. 수타면 짬뽕 단품이 시그니처이며, 청계산 산행 후 점심·차량 식사 시나리오에 자주 누적됩니다. 백현동·아브뉴프랑 동선과 떨어진 판교동 매장이라 동선 분산 차원에서도 의미가 있고, 차량 이용자 위주 매장입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
