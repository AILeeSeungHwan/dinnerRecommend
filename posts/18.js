...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4 · 리뷰 3,609건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4 · 리뷰 761건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px"><strong>원적외선 직화 돼지양념구이 280g 21,000원</strong>이 시그니처 메뉴인 돼지갈비 전문점입니다. 망포동 332-7 1층에 위치하며 <strong>11:20 영업 시작</strong>이라 점심 가족 외식부터 저녁 회식까지 폭이 넓습니다. 평점 4.4점·리뷰 109건으로 평점 우위 식당이며, <strong>"콜키지 프리"</strong>가 메뉴판에 명시되어 와인·소주를 직접 가져와 마실 수 있는 매장입니다. 사이드 메뉴(소고기 된장찌개 7,000원·물냉면 7,000원·공기밥 2,000원)가 잘 갖춰져 있어 마무리 식사까지 한 곳에서 해결되는 곳입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">방문자 후기 키워드 정리</p>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">영통동 975-6 1층에 위치한 <strong>한돈+한우 멀티 정찬</strong> 매장입니다. 평점 4.3점·리뷰 108건이 누적되었고, <strong>03:00 영업 종료</strong>로 본 가이드 5곳 중 가장 늦은 시간까지 운영되는 식당입니다. 한돈 생삼겹살 16,000원·생목살 16,000원의 평일 단가부터 시작해 황금등심살 한판 88,000원, 고마블와규 소한마리(등심2+부채1+본갈비살1) 128,000원까지 가격 폭이 넓어 회식 예산에 맞춰 메뉴 구성을 조정할 수 있습니다. <strong>한돈커플세트 47,000원</strong>은 2인 데이트·기념일 가성비 옵션으로 묶입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">방문자 후기 키워드 정리</p>
