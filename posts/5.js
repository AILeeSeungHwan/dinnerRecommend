const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: "<p><a href=\"/dinner/samseong/restaurant/수림복국 선릉 삼성 별관\">수림복국 선릉 삼성 별관</a>은 기타 카테고리에 속하는 식당으로입니다.</p><p>점심 시간 회전이 빠른 편이라 직장인 점심으로 적합합니다 가격 대비 양·구성이 합리적이라는 평이 많습니다</p><p style=\"font-size:.85rem;color:var(--muted)\">📌 예약 가능 · 영업시간 10:00 · 위치 삼성동 144-21</p><p>방문 후기에서 자주 언급되는 부분은 맛·분위기·국물 쪽입니다.</p><p><a href=\"/dinner/samseong/restaurant/수림복국 선릉 삼성 별관\" style=\"color:var(--primary);font-weight:600\">→ 수림복국 선릉 삼성 별관 메뉴·리뷰·위치 자세히 보기</a></p>",
    },
    {
      type: 'h2',
      id: "compare",
