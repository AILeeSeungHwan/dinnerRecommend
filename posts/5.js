...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">스타필드 코엑스몰 지하 1층 O-107호 라운지, <strong>한식 솥밥 단일 카테고리</strong>로 평점 4.9점·리뷰 4,967건이 누적된 매장입니다. 시그니처 메뉴는 매콤한 신메뉴 불쭈꾸미 솥밥 15,900원이며, 점심 회전이 빨라 평일 12시 피크에도 웨이팅이 30분 안에 끝나는 편입니다. "혼밥 가능·점심추천·웨이팅 맛집" 세 가지 평가가 함께 묶여 있어 직장인 점심 1인 식사로 좋고, 매장 자체가 코엑스몰 라운지에 위치해 환승 동선이 짧습니다. 10:30 영업 시작이라 11시대 일찍 가시면 더 안전합니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.7 · 리뷰 1,325건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">봉은사로 84길 10, <strong>두꺼운 패티+칠리프라이+고구마튀김</strong> 라인업이 강점인 수제버거 매장입니다. 평점 3.7점·리뷰 1,325건으로 본 가이드 버거 카테고리 검증 옵션이며, 시작가 9,800원·디럭스 스택 세트 15,400원으로 1인 1만원대에 마칠 수 있습니다. 11:00~21:30 영업이라 점심 회전이 빠르고, 12시 피크에도 단품 조립이 빠른 매장이라 30분 안에 입장~퇴장이 가능합니다. 혼밥·회식 평가가 함께 묶여 있어 1인 빠른 점심 또는 4~6인 캐주얼 점심 모임에도 매칭이 좋습니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
