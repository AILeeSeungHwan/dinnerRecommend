const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: "<p>영통역·삼성전자 근처에서 점심 괜찮은 곳을 찾고 계시는 분들을 위해 준비하였습니다. 6곳을 추려서 가격과 메뉴까지 상세하게 정리하였습니다.</p><p>평균 평점 4.4점입니다. 가격대는 10,000원부터 시작하며, 2026년 5월 기준이며, 접근성·회전율·세트 메뉴·가격을 위주로 비교하였습니다.</p><p>소개 순서: 화붐 신간짬뽕 본점, 피자펍, 이수국밥, 김래하닭갈비, 돈부리인생.</p>",
    },
    {
      type: 'toc',
    },
    ...
    {
      type: 'body',
      html: "<p><a href=\"/samsungElectronics/yeongtong/restaurant/피자펍\">피자펍</a>은 양식 카테고리에 속하는 식당으로입니다. 평점 4.6점, 리뷰 5건 수준이라 표본은 작지만 평가가 좋은 편입니다.</p><p>1인 기준 가격대는 10,000원에서 20,000원 사이로 형성되어 있습니다. 이 카테고리 평균 시작가(10,000원)와 비슷한 수준입니다.</p><p>점심 시간 회전이 빠른 편이라 직장인 점심으로 적합합니다 분위기가 무난한 편이라 가벼운 데이트로도 무리가 없습니다</p><p style=\"font-size:.85rem;color:var(--muted)\">📌 영업시간 11:00 AM~10:00 PM · 위치 영통동 990-22</p><div style=\"margin:18px 0 8px;text-align:center\"><a href=\"/samsungElectronics/yeongtong/restaurant/피자펍\" style=\"display:inline-flex;align-items:center;gap:8px;padding:13px 26px;border-radius:12px;background:linear-gradient(135deg,#FF6B6B 0%,#FFD93D 100%);color:#1a1a22;font-weight:800;font-size:.92rem;text-decoration:none;box-shadow:0 4px 14px rgba(255,107,107,.35);transition:transform .15s\">🍽 피자펍 메뉴·리뷰·위치 보기 →</a></div>",
    },
    {
      type: 'h2',
      id: "이수국밥",
    ...
    {
      type: 'body',
      html: "<p><a href=\"/samsungElectronics/yeongtong/restaurant/돈부리인생\">돈부리인생</a>은 일식 카테고리에 속하는 식당으로입니다. 평점 4.1점, 리뷰 14건 수준이라 표본은 작지만 평가가 좋은 편입니다.</p><p>1인 기준 가격대는 10,000원에서 20,000원 사이로 형성되어 있습니다. 이 카테고리 평균 시작가(10,000원)와 비슷한 수준입니다.</p><p>점심 시간 회전이 빠른 편이라 직장인 점심으로 적합합니다 분위기가 무난한 편이라 가벼운 데이트로도 무리가 없습니다 점심 12시·저녁 7시 같은 피크 시간대에는 웨이팅을 각오해야 합니다 가격 대비 양·구성이 합리적이라는 평이 많습니다</p><p style=\"font-size:.85rem;color:var(--muted)\">📌 영업시간 11:30 AM~9:00 PM · 위치 영통동 번지</p><div style=\"margin:18px 0 8px;text-align:center\"><a href=\"/samsungElectronics/yeongtong/restaurant/돈부리인생\" style=\"display:inline-flex;align-items:center;gap:8px;padding:13px 26px;border-radius:12px;background:linear-gradient(135deg,#FF6B6B 0%,#FFD93D 100%);color:#1a1a22;font-weight:800;font-size:.92rem;text-decoration:none;box-shadow:0 4px 14px rgba(255,107,107,.35);transition:transform .15s\">🍽 돈부리인생 메뉴·리뷰·위치 보기 →</a></div>",
    },
    {
      type: 'h2',
      id: "청우회관",
    ...
    {
      type: 'body',
      html: "<ul><li><strong>가성비 우선:</strong> 화붐 신간짬뽕 본점, 돈부리인생 — 합리적인 가격에 만족스러운 식사가 가능합니다.</li><li><strong>분위기 중시:</strong> 화붐 신간짬뽕 본점, 피자펍 — 데이트나 특별한 날에 추천합니다.</li><li><strong>단체·회식:</strong> 화붐 신간짬뽕 본점, 김래하닭갈비 — 단체석 또는 룸이 있어 회식에 적합합니다.</li><li><strong>평점 최고:</strong> 피자펍 (평점 4.6점) — 방문자 평가가 가장 높습니다.</li><li><strong>리뷰 최다:</strong> 화붐 신간짬뽕 본점 (리뷰 123건) — 가장 많은 방문자가 검증한 식당입니다.</li></ul>",
    },
    {
      type: 'h2',
      id: "tips",
