...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">전국 체인 <strong>신선설농탕</strong>의 수원영통점입니다. 영통동 976-17에 위치해 영통역 도보 거리이며, <strong>10:00 영업 시작</strong>이라 늦은 아침·점심·이른 저녁까지 활용도가 넓습니다. 평점 3.4점·리뷰 2,957건으로 본 가이드 5곳 중 두 번째로 많은 표본을 누적했고, "어린이 설농탕 8,000원"·"미역설농탕 14,000원" 등 가족 외식 메뉴까지 갖춰 1인 직장인부터 부모님과 함께 오는 가족까지 폭넓게 묶입니다. 정식 메뉴 표준화가 잘 되어 있어 첫 방문에도 메뉴 실패 확률이 낮은 편입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.2 · 리뷰 1,618건</span>
