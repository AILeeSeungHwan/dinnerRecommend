...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.6 · 리뷰 255건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px"><strong>본 가이드 5곳 중 평점 1순위(★ 4.6)</strong>인 양식 스테이크 매장입니다. 성남시 수정구 사송동 562-3 1·2층, 판교역 차량 이동권에 자리잡고 있어 점심 데이트·기념일·소규모 회식이 함께 누적되는 식당입니다. 리뷰 255건 표본이 안정적이고, "분위기 좋음 · 맛있음" 키워드가 함께 매칭됩니다. 점심 시간대 양식 단품 + 사이드 조합으로 1인 3만원선이 표준이며, 단가 부담은 있지만 다른 4곳과 카테고리가 겹치지 않아 고기 점심을 양식으로 풀고 싶은 날 선택지로 묶었습니다.</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.4 · 리뷰 410건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">평점 4.4점·리뷰 410건으로 판교 돼지고기구이 카테고리에서 가장 안정된 표본을 가진 매장입니다. 삼평동 740, <strong>아브뉴프랑 1층</strong>에 자리잡고 있어 회식·동료 점심·약속이 함께 누적되는 입지입니다. <strong>주차 가능 + 예약 가능</strong>이 모두 표시된 식당이라 5~8인 팀 점심 회식에 부담이 적고, 아브뉴프랑 동선 안에 있어 식후 카페·디저트 이동도 짧습니다. 단가는 1인 25,000원선이 표준으로, 돼지고기 단품 + 사이드 조합이 가장 안정적인 주문 패턴입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.9 · 리뷰 489건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">평점 3.9 · <strong>리뷰 489건</strong>으로 본 가이드 5곳 중 정육식당 카테고리 표본 1순위입니다. 삼평동 656 1층, 판교역 도보 동선에 자리잡고 있어 점심 단체 주문이 자주 쌓이는 매장입니다. 평점이 3.9점인 점은 한계로 짚어둘 필요가 있지만, 489건이라는 표본 크기가 평균값을 안정시켜주며, 정육식당 특유의 "두툼한 부위 직접 손질 + 푸짐한 양" 시나리오가 후기에 누적됩니다. 점심 1인 25,000원선 한 끼가 표준이며, 2~3인 단체로 구성하면 1인 단가가 더 낮아지는 구조입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.2 · 리뷰 187건</span>
