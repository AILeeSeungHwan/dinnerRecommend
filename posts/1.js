...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">평점 4.4 · 리뷰 410건으로 판교 돼지고기구이 카테고리에서 가장 안정된 표본을 가진 매장입니다. 삼평동 740, <strong>아브뉴프랑 1층</strong>에 자리잡고 있어 회식·동료 점심·약속이 함께 누적되는 입지입니다. <strong>주차 가능 + 예약 가능</strong>이 모두 표시된 식당이라 5~8인 팀 점심 회식에 부담이 적고, 아브뉴프랑 동선 안에 있어 식후 카페·디저트 이동도 짧습니다. 단가는 1인 25,000원선이 표준으로, 돼지고기 단품 + 사이드 조합이 가장 안정적인 주문 패턴입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.9 · 리뷰 146건</span>
