const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: "<p>횟집·해산물 하면 <a href=\"/dinner/samseong/restaurant/해화장\">해화장</a>도 빠지지 않는다. 4.9점.</p><p>대표 메뉴는 [봄, 바다향 터지는] 봄멍게 23,000원, [봄,바다향 터지는] 돌멍게 38,000원.</p><p>주차도 된다.</p><p>인기 많아서 웨이팅이 좀 있는 편이다.</p><p><a href=\"/dinner/samseong/restaurant/해화장\" style=\"color:var(--primary)\">→ 상세 보기</a></p>",
    },
    {
      type: 'h2',
      id: "일상정원-코엑스점",
    ...
    {
      type: 'body',
      html: "<p><a href=\"/dinner/samseong/restaurant/모도우 삼성\">모도우 삼성</a>. 평점 4.6점, 리뷰 154건 정도 있다.</p><p>가격대 9,000~15,000원.</p><p><a href=\"/dinner/samseong/restaurant/모도우 삼성\" style=\"color:var(--primary)\">→ 상세 보기</a></p>",
    },
    {
      type: 'h2',
      id: "논두렁오리주물럭-선릉직영점",
    ...
    {
      type: 'body',
      html: "<p>양념 오리 주물럭(2인~3인) 58,000원. <a href=\"/dinner/samseong/restaurant/논두렁오리주물럭 선릉직영점\">논두렁오리주물럭 선릉직영점</a>의 간판 메뉴다. 양념 오리 주물럭(2인~3인), 양념 오리 주물럭(2인~3인)도 많이 시킨다.</p><p>그 외에 대패 주물럭 한판(2~3인), 대패 주물럭 한판 반(4인)도 있다.</p><p>주차는 된다. 예약 가능.</p><p>5점짜리 식당이 흔하진 않다. 리뷰도 485건. 코스 기준 인당 0~5만원대. 특별한 날에 맞는 가격.</p><p>맛에 대한 만족도가 높은 편이다. 주차가 편하다는 의견이 있다.</p><p><a href=\"/dinner/samseong/restaurant/논두렁오리주물럭 선릉직영점\" style=\"color:var(--primary)\">→ 논두렁오리주물럭 선릉직영점 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "compare",
