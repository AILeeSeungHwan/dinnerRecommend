const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: "<p><a href=\"/dinner/samseong/restaurant/해화장\">해화장</a>. 횟집·해산물 전문점으로, 평점 4.9점에 리뷰 47건을 기록하고 있습니다.</p><p>[봄, 바다향 터지는] 봄멍게 23,000원이 가장 인기 있는 메뉴이며, [봄,바다향 터지는] 돌멍게 38,000원도 추천드립니다.</p><p>주차도 가능합니다. 예약이 가능합니다.</p><p>평점 4.9점이면 이 동네에서 상위권에 해당합니다. 리뷰 47건이 쌓여 있어 신뢰도도 높은 편입니다.</p><p>인기가 많아서 웨이팅이 좀 있는 편입니다. 점심 피크 시간을 피하시면 대기 시간을 줄일 수 있습니다. 재료가 신선합니다. 당일 재료를 사용한다는 점에서 식재료에 대한 신뢰도가 높습니다.</p><p><a href=\"/dinner/samseong/restaurant/해화장\" style=\"color:var(--primary)\">→ 해화장 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "일상정원-코엑스점",
    ...
    {
      type: 'body',
      html: "<p><a href=\"/dinner/samseong/restaurant/일상정원 코엑스점\">일상정원 코엑스점</a>에서 가장 많이 나가는 메뉴는 구름 스키야키(관서식)입니다. 가격은 21,400원입니다. 그 외에도 미소 샤브샤브(관동식), NEW, 사케마구로동를 많이 찾으십니다.</p><p>그 외에 NEW, 지라시스시(25,400원), NEW, 규나베 서로인 한우 1++(32,400원)도 있습니다.</p><p>주차가 가능합니다. 예약이 가능합니다.</p><p>4.8점짜리 식당은 흔하지 않습니다. 리뷰도 706건이나 되어 검증된 맛집이라 하겠습니다.</p><p>재방문 의사가 있다는 리뷰가 많습니다. 한 번 가보시면 단골이 될 가능성이 높은 곳입니다. 재료가 신선합니다. 당일 재료를 사용한다는 점에서 식재료에 대한 신뢰도가 높습니다. 맛에 대한 만족도가 높은 편입니다. 전반적으로 음식 맛에 대한 긍정적인 평가가 많습니다.</p><p><a href=\"/dinner/samseong/restaurant/일상정원 코엑스점\" style=\"color:var(--primary)\">→ 일상정원 코엑스점 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "솔트랑-스테이크-삼성",
    ...
    {
      type: 'body',
      html: "<p>양념 오리 주물럭(2인~3인) 58,000원. <a href=\"/dinner/samseong/restaurant/논두렁오리주물럭 선릉직영점\">논두렁오리주물럭 선릉직영점</a>의 간판 메뉴입니다. 한마리(2~3인)  (고기800g+야채). 양념 오리 주물럭(2인~3인), 양념 오리 주물럭(2인~3인)도 함께 주문하시는 분들이 많습니다.</p><p>그 외에 대패 주물럭 한판(2~3인)(36,000원), 대패 주물럭 한판 반(4인)(48,000원)도 있습니다.</p><p>주차가 가능합니다. 예약이 가능합니다.</p><p>5점짜리 식당은 흔하지 않습니다. 리뷰도 485건이나 되어 검증된 맛집이라 하겠습니다. 인당 0~5만원 선입니다. 데이트 코스로 적합한 가격대입니다.</p><p>맛에 대한 만족도가 높은 편입니다. 전반적으로 음식 맛에 대한 긍정적인 평가가 많습니다. 주차가 편하다는 의견이 있습니다. 차량으로 방문하시는 분들에게 유리한 조건입니다. 매장이 깔끔하게 관리되고 있습니다.</p><p><a href=\"/dinner/samseong/restaurant/논두렁오리주물럭 선릉직영점\" style=\"color:var(--primary)\">→ 논두렁오리주물럭 선릉직영점 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "compare",
