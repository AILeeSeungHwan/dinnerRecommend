...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.9 · 리뷰 2,102건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">영동대로 513 코엑스몰에 위치한 양식 매장입니다. 평점 4.7점·리뷰 5,704건이 누적되었고, 데이트·가족 식사·리뷰 많음·주차 가능 평가가 함께 매칭됩니다. <strong>피자 한 판에 파스타 한 접시</strong>로 시작가 9,900원·시그니처 25,900원선의 1만원대 데이트 비용을 잡을 수 있어, 점심 데이트 또는 코엑스몰 쇼핑·아쿠아리움·별마당 도서관 일정과 묶기 좋습니다. 22:00 영업이라 저녁 코스로도 가능합니다. 코엑스몰 안 매장 특성상 12~13시 피크엔 웨이팅이 생길 수 있어 11:30 또는 13:30 입장이 더 안전합니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.3 · 리뷰 721건</span>
