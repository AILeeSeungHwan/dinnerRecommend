const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: "<p>잠실에서 일식·스시 식당을 찾고 계신다면, 이 글 하나로 정리해 드리겠습니다. 총 1149곳 중 일식·스시 5곳을 엄선하여 비교하였습니다.</p><p>평균 평점 4.4점입니다. 가격대는 11,000원부터 시작하며, 2026년 5월 기준이며, 오마카세 등급·예약·코스 가격을 위주로 비교하였습니다.</p><p>소개 순서: 아사히 스시, 김태완스시, 마싯내, 분지로 롯데월드몰점, 오사이초밥 잠실.</p>",
    },
    {
      type: 'toc',
    },
    ...
    {
      type: 'body',
      html: "<p><a href=\"/dinner/jamsil/restaurant/분지로 롯데월드몰점\">분지로 롯데월드몰점</a>은 일식 카테고리에 속하는 식당으로입니다. 평점 4.2점에 리뷰 111건으로 안정적인 평가가 쌓여 있습니다.</p><p>일식 단품 위주로 가볍게 들르기 좋은 곳입니다</p><p style=\"font-size:.85rem;color:var(--muted)\">📌 위치 신천동 29</p><div style=\"margin:18px 0 8px;text-align:center\"><a href=\"/dinner/jamsil/restaurant/분지로 롯데월드몰점\" style=\"display:inline-flex;align-items:center;gap:8px;padding:13px 26px;border-radius:12px;background:linear-gradient(135deg,#FF6B6B 0%,#FFD93D 100%);color:#1a1a22;font-weight:800;font-size:.92rem;text-decoration:none;box-shadow:0 4px 14px rgba(255,107,107,.35);transition:transform .15s\">🍽 분지로 롯데월드몰점 메뉴·리뷰·위치 보기 →</a></div>",
    },
    {
      type: 'h2',
      id: "오사이초밥-잠실",
    ...
    {
      type: 'body',
      html: "<ul><li><strong>분위기 중시:</strong> 김태완스시, 오사이초밥 잠실 — 데이트나 특별한 날에 추천합니다.</li><li><strong>평점 최고:</strong> 아사히 스시 (평점 4.9점) — 방문자 평가가 가장 높습니다.</li><li><strong>리뷰 최다:</strong> 아사히 스시 (리뷰 513건) — 가장 많은 방문자가 검증한 식당입니다.</li></ul>",
    },
    {
      type: 'h2',
      id: "tips",
