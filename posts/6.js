...
<p style="font-size:15px;margin:0;line-height:1.8">잠실 일식 표본이 가장 큰 1순위는 <strong>상무초밥 잠실본점</strong> — 리뷰 1,840건, 가성비 진심초밥 10p 15,900원·시그니처 상무초밥 10p 22,900원. 평점 1위면 <strong>채선당 샤브보트 롯데백화점 잠실점</strong> — 평점 4.9·리뷰 449건, 백화점 지하 1층 일식 샤브샤브. 1만원선 라멘이면 <strong>오레노라멘송파</strong> — 토리빠이탄 라멘 13,000원, 평점 4.5·리뷰 601건. 7천원선 돈카츠 가성비면 <strong>교차점</strong> — 오렌지 치즈카츠 8,000원·히레카츠정식 14,000원. 데이트 사케동·연어회면 <strong>가일</strong> — 사케동 15,000원·특가일초밥 10p 26,000원.</p>
    ...
    { type: 'h2', id: 'criteria', text: '잠실 일식·스시 맛집 선정 기준', gradientStyle: { from: '#185FA5', to: '#0EA5E9' } },
    {
      type: 'body',
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">리뷰 2,058건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.1 · 리뷰 1,394건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px"><strong>평점 3.1점·리뷰 1,394건으로 본 가이드 5곳 중 평점 1위</strong>인 일식 샤브샤브 매장입니다. 잠실동 40-1 롯데백화점 잠실점 지하 1층에 자리해 잠실역 지하상가에서 도보 1분으로 접근 가능합니다. 백화점 식당가 입점 매장이라 매장 청결·서비스 표준이 일정하게 유지되며, 평점이 4.9로 매우 높지만 리뷰 1,394건의 표본이 같이 따라와 신뢰도가 함께 검증되는 식당입니다. 백화점 운영시간을 따르므로 평일·주말 모두 점심·디너 시간대가 안정적이고, 가족 외식·평일 점심 데이트·쇼핑 동선 사이 한 끼에 잘 맞습니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.3 · 리뷰 3,191건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.5 · 리뷰 2,462건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">석촌동 184-8 덕수빌딩 104호에 자리한 돈카츠 전문점으로, 평점 4.5점·리뷰 2,462건 안정 표본을 갖춘 잠실 돈카츠 가성비 1순위입니다. "리뷰많음·혼밥가능·가성비·주차가능" 네 태그가 동시에 매칭되어 평일 점심 1시간 한 끼·점심 데이트·혼밥 디너 모두 가능합니다. <strong>오렌지 치즈카츠 8,000원이 잠실 일식 카테고리에서 가장 저렴한 단품 옵션</strong> 중 하나이고, 히레카츠정식 14,000원·특 로스카츠 14,000원이 메인 정식입니다. 11:30 영업 시작으로 점심 피크 12시 전 진입이 안전합니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.9 · 리뷰 3,356건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">방이동 48-7 1층에 자리한 일식당으로, 평점 3.9점·리뷰 3,356건의 안정 표본과 "주차가능·리뷰많음·서비스좋음" 세 태그가 함께 매칭되어 있습니다. <strong>사케동 15,000원이 메인 점심 단품</strong>이고, 특가일초밥 10p 26,000원·연어회 中 38,000원이 디너·데이트 메인 메뉴입니다. 11:30 영업 시작으로 점심 데이트·평일 디너 시간대 모두 가능하고, 주차장 운영이라 차량 방문 옵션도 함께 가능합니다. 일식·스시 카테고리에서 1인 1.5~3만원선 가격대로 데이트·기념일 가벼운 외식에 적합한 옵션입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
