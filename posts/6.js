...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">리뷰 2,057건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.3 · 리뷰 3,190건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 0 · 리뷰 2,461건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">석촌동 184-8 덕수빌딩 104호에 자리한 돈카츠 전문점으로, 평점 0점·리뷰 2,461건 안정 표본을 갖춘 잠실 돈카츠 가성비 1순위입니다. "리뷰많음·혼밥가능·가성비·주차가능" 네 태그가 동시에 매칭되어 평일 점심 1시간 한 끼·점심 데이트·혼밥 디너 모두 가능합니다. <strong>오렌지 치즈카츠 8,000원이 잠실 일식 카테고리에서 가장 저렴한 단품 옵션</strong> 중 하나이고, 히레카츠정식 14,000원·특 로스카츠 14,000원이 메인 정식입니다. 11:30 영업 시작으로 점심 피크 12시 전 진입이 안전합니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
