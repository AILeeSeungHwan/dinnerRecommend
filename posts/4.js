...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.7 · 리뷰 1,000건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4 · 리뷰 3,889건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">수정구 시흥동 296-3 파미어스몰 2층, 판교아이스퀘어 동선 안의 1인 샤브샤브 매장입니다. <strong>멸치샤브 우삼겹 12,900원</strong>이 시작가로 본 가이드 1만원대 카테고리 안에 깔끔하게 들어옵니다. 멸치샤브·된장샤브·간장샤브 3가지 베이스에 우삼겹·목심·쭈꾸미 토핑을 조합하면 12,900~16,400원선까지 단가가 자연스럽게 올라가며, 1인 1냄비 운영이라 혼밥 시나리오에 동선이 깔끔합니다. 평점 4점·리뷰 244건은 본 5곳 중 평점은 평균선이지만, "맛있다 · 국물맛 · 분위기" 키워드가 함께 매칭되어 한 끼 만족도가 안정적인 편입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
