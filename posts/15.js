const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: "<p>분위기가 좋아서 눈에 들어오는 곳입니다. <a href=\"/dinner/samseong/restaurant/이치류 선릉점\">이치류 선릉점</a>.</p><p>주차가 가능합니다. 예약이 가능합니다.</p><p>4.9점·리뷰 113건. 방문자 평이 비교적 일관되게 좋은 편입니다. 환기 시설이 잘 되어 있는 편이지만, 옷에 냄새가 신경 쓰이시면 갈아입을 옷을 챙기시는 것도 방법입니다.</p><p>재방문 의사가 있다는 리뷰가 많습니다. 한 번 가보시면 단골이 될 가능성이 높은 곳입니다. 맛에 대한 만족도가 높은 편입니다. 전반적으로 음식 맛에 대한 긍정적인 평가가 많습니다.</p><p>한 방문자는 \"직원분들이 모두 친절하시고 고기도 너무 잘 구워주시고 덕분에 즐거운 회식 이었습니다\"고 적어두었습니다.</p><p>방문 후기에서 자주 언급되는 부분은 서비스·맛·재방문 쪽입니다.</p><p><a href=\"/dinner/samseong/restaurant/이치류 선릉점\" style=\"color:var(--primary)\">→ 이치류 선릉점 상세 정보 보기</a></p>",
    },
    {
      type: 'image',
