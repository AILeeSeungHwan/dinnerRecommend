const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: "<p><a href=\"/dinner/samseong/restaurant/연송\">연송</a>. 육류 전문이고 평점 5점(리뷰 3건).</p><p>메뉴: 통가브리살 17,000원 / ++삼겹살 17,000원 / 두툼목살 17,000원 / 벌집껍데기 6,000원.</p><p>혼밥 가능. 단체석이나 룸이 있다.</p><p><a href=\"/dinner/samseong/restaurant/연송\" style=\"color:var(--primary)\">→ 상세 보기</a></p>",
    },
    {
      type: 'h2',
      id: "compare",
