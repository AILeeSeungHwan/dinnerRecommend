...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.8 · 리뷰 766건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px"><strong>본 가이드 5곳 중 평점 4.8로 1위</strong>인 한우곱창 전문점입니다. 방이동 60번지 1층, 잠실 방이먹자골목 안쪽에 위치하며 8호선 방이역과 잠실역 모두 도보권입니다. 리뷰 766건은 평점이 단순 신규 효과가 아니라 충분한 표본으로 누적된 수치이고, "웨이팅맛집·서비스좋음·리뷰많음" 세 태그가 동시에 매칭되는 식당입니다. 16:00 영업 시작이라 회식 1차 6시 입장이 표준 동선이며, 평일 저녁 7~8시 피크에는 30분 이상 대기가 발생할 수 있어 단체 회식은 사전 전화 확인을 권장드립니다.</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.5 · 리뷰 176건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.3 · 리뷰 486건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">잠실동 186번지 지하 1층에 자리한 장어·한우 동시 운영 식당입니다. 평점 4.3점·리뷰 486건이 누적되어 카테고리 표준 범위 안에 있고, "리뷰많음·점심추천·주차가능·단체가능·서비스좋음" 다섯 태그가 한꺼번에 매칭되는 식당이라 임원 회식·외부 접대 자리에 안정적입니다. <strong>한우 갈비살 1++ 100g 39,000원</strong>·<strong>국산 민물장어 1kg 108,000원</strong>이 메인 옵션으로, 1인 평균 4~10만원 예산이 표준입니다. 지하 단체석 구조라 외부 시선이 차단되어 회식 분위기를 만들기 좋고, 11:00 영업 시작이라 점심 비즈니스 미팅도 가능합니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.5 · 리뷰 255건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">평점 4.5점·리뷰 255건이 누적된 방이동 양꼬치 전문점입니다. 방이동 63-6번지, 진성한우곱창과 같은 골목 안에 있어 1차·2차를 같은 동네에서 묶기에 좋습니다. "가성비·리뷰많음·서비스좋음" 세 태그가 매칭되어 있고, 양꼬치 16,000원·고급양갈비 30,000원·찹쌀탕수육 20,000원 라인업이라 1인 평균 2만원선 회식이 가능합니다. 16:00 영업 시작으로 저녁 회식 전용 운영이며, 양고기·마라요리·중식 단품을 한 자리에서 묶어 시키는 동선이 가능한 식당입니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.4 · 리뷰 585건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">평점 3.4점은 본 가이드 5곳 중 가장 낮은 편입니다. 다만 <strong>리뷰 585건</strong>으로 표본이 안정적이고, "점심추천·주차가능·단체가능·리뷰많음·깔끔한곳" 다섯 태그가 동시에 매칭되는 중식당입니다. 방이동 36-7번지, 짜장면 9,000원·간짜장 10,000원·군만두 8,000원 라인업으로 <strong>1차 점심 회식·해장 회식</strong>이 가능한 1만원대 가성비 옵션이고, 동파육 43,000원·생등심탕수육 30,000원 같은 코스 메뉴로 단체 회식까지 확장 가능합니다. 평점이 다소 낮은 이유는 단품 회전이 빠른 식당 특성상 호불호 평가가 함께 누적된 것으로 해석되며, 메인 메뉴(짜장·동파육·탕수육) 위주로 주문하시면 만족도 편차가 줄어듭니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
