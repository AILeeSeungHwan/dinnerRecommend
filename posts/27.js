const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: "<p>강남역에서 데이트 식당을 찾고 계신다면, 이 글 하나로 정리해 드리겠습니다. 총 285곳 중 데이트 7곳을 엄선하여 비교하였습니다.</p><p>평균 평점 0점입니다. 가격대는 4,000원부터 시작하며, 2026년 5월 기준이며, 분위기·코스 구성·예약 여부·뷰을 위주로 비교하였습니다.</p><p>소개 순서: 82올리언즈 강남점, 플랫나인, 빨간의자집 강남역점, 쿄코코 신논현점, 진구곱창 강남역본점.</p>",
    },
    {
      type: 'toc',
    },
    ...
    {
      type: 'body',
      html: "<p>강남역 전체 285곳에서 데이트 카테고리에 해당하는 식당을 선별하였습니다. 평점 0점 이상, 분위기·코스 구성·예약 여부·뷰 기준으로 비교하였습니다. 2026년 5월 데이터 기준이므로, 폐업이나 가격 변동이 있을 수 있으니 방문 전에 반드시 확인하시기 바랍니다.</p>",
    },
    {
      type: 'h2',
      id: "82올리언즈-강남점",
      text: "82올리언즈 강남점 — 한식 전문점",
      gradientStyle: { from: '#4facfe', to: '#00f2fe' },
    },
    {
      type: 'body',
      html: "<p><a href=\"/dinner/gangnam/restaurant/82올리언즈 강남점\">82올리언즈 강남점</a>에서 가장 많이 나가는 메뉴는 올리언즈 라자냐입니다. 가격은 19,000원입니다. 올리언즈 스테이크, 몬테크리스토 같은 메뉴도 인기가 좋습니다.</p><p>그 외에 볼케이노 맥앤치즈(12,000원), 홈메이드 뇨끼&amp;치즈 퐁듀(22,000원), 페페로니 토마토 파스타(18,000원)도 있습니다.</p><p>주차가 가능합니다. 예약이 가능합니다.</p><p>인기가 많아서 웨이팅이 좀 있는 편입니다. 점심 피크 시간을 피하시면 대기 시간을 줄일 수 있습니다. 맛에 대한 만족도가 높은 편입니다. 전반적으로 음식 맛에 대한 긍정적인 평가가 많습니다.</p><p>한 방문자는 \"미국 다이너 감성 분위기가 매력적이었고 음식도 전체적으로 맛있었어요\"고 적어두었습니다.</p><p>방문 후기에서 자주 언급되는 부분은 맛·분위기·웨이팅 쪽입니다.</p><p><a href=\"/dinner/gangnam/restaurant/82올리언즈 강남점\" style=\"color:var(--primary)\">→ 82올리언즈 강남점 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "플랫나인",
    ...
    {
      type: 'body',
      html: "<p><a href=\"/dinner/gangnam/restaurant/꼬끼오 장작구이\">꼬끼오 장작구이</a>. 고기구이 전문점으로,</p><p>한방누룽지통닭 19,900원이 가장 인기 있는 메뉴이며, 코리아바베큐통닭 26,000원, 통통마늘통닭 26,000원도 추천드립니다.</p><p>가성비가 좋다는 평이 많습니다.</p><p>재방문 의사가 있다는 리뷰가 많습니다. 한 번 가보시면 단골이 될 가능성이 높은 곳입니다. 맛에 대한 만족도가 높은 편입니다. 전반적으로 음식 맛에 대한 긍정적인 평가가 많습니다.</p><p>방문 후기에서 자주 언급되는 부분은 맛·분위기·서비스 쪽입니다.</p><p><a href=\"/dinner/gangnam/restaurant/꼬끼오 장작구이\" style=\"color:var(--primary)\">→ 꼬끼오 장작구이 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "compare",
      text: "강남역 데이트 맛집 한눈에 비교",
      gradientStyle: { from: '#A8EDEA', to: '#FED6E3' },
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: "<ul><li><strong>가성비 우선:</strong> 플랫나인, 진구곱창 강남역본점 — 합리적인 가격에 만족스러운 식사가 가능합니다.</li><li><strong>단체·회식:</strong> 빨간의자집 강남역점, 밤별 포차 라운지 강남역본점 — 단체석 또는 룸이 있어 회식에 적합합니다.</li><li><strong>평점 최고:</strong> 82올리언즈 강남점 (평점 0점) — 방문자 평가가 가장 높습니다.</li><li><strong>리뷰 최다:</strong> 쿄코코 신논현점 (리뷰 11673건) — 가장 많은 방문자가 검증한 식당입니다.</li></ul>",
    },
    {
      type: 'h2',
      id: "tips",
    ...
    {
      type: 'body',
      html: "<ul><li>빨간의자집 강남역점, 진구곱창 강남역본점은 점심 피크 시간(12시~12시 30분)에 대기가 있을 수 있습니다. 11시 50분 이전에 방문하시는 것을 추천드립니다.</li><li>82올리언즈 강남점, 플랫나인은 사전에 예약하고 방문하시는 것이 좋습니다. 특히 주말 저녁에는 예약이 필수입니다.</li><li>주차 가능한 곳: 82올리언즈 강남점, 빨간의자집 강남역점, 쿄코코 신논현점.</li><li>플랫나인, 밤별 포차 라운지 강남역본점 등은 전용 주차장이 없습니다. 대중교통 이용을 권장드립니다.</li><li>데이트를 계획하신다면 예약은 필수입니다. 금요일·토요일 저녁은 최소 3일 전에 예약하시기 바랍니다.</li></ul>",
    },
    {
      type: 'cta',
      href: "/dinner/gangnam/category/date",
      text: "강남역 데이트 맛집 전체 보기 →",
    },
    {
      type: 'ending',
      html: "<p>2026년 5월 기준 정보입니다. 영업시간이나 가격은 변동될 수 있으므로, 방문 전에 한 번 확인하시는 것을 권장드립니다. 아래 관련 글도 함께 참고해 주시기 바랍니다.</p><ul><li><a href=\"/posts/gangnam-meat-best-2026\">강남역 고기 맛집 추천 7곳</a></li><li><a href=\"/posts/gangnam-team-dinner-best-2026\">강남역 회식 장소 추천 7곳</a></li><li><a href=\"/posts/gangnam-budget-best-2026\">강남역 가성비 맛집 추천 7곳</a></li><li><a href=\"/posts/gangnam-izakaya-best-2026\">강남역 이자카야·술집 추천 7곳</a></li><li><a href=\"/dinner/gangnam\">강남역 전체 맛집 보기</a></li></ul>",
    }
  ],
}
