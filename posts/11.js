...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4.6 · 리뷰 205건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.7 · 리뷰 876건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">석촌동 183-7번지에 위치한 제주식 해장국 직영점으로, 평점 3.7점·리뷰 876건이 누적되어 본 가이드 5곳 중 평점·표본 양쪽에서 안정적입니다. "주차가능·리뷰많음·깔끔한곳·서비스좋음" 네 태그가 동시에 매칭되어 직장인 평일 점심·가족 외식 모두 가능합니다. <strong>해장국 12,000원이 메인 단품</strong>이며 제주 돔베고기(소 13,000원·중 24,000원·대 35,000원) 라인업으로 해장국 한 그릇만이 아니라 디너 가족 외식까지 확장 가능한 식당입니다. <strong>9:00 영업 시작</strong>이라 늦은 아침 해장 식사 옵션으로도 활용 가능합니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3 · 리뷰 1,943건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.6 · 리뷰 928건</span>
