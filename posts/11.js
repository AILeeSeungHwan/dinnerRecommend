const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: "<p><a href=\"/dinner/jamsil/restaurant/화목\">화목</a>. 덮밥 전문이고 평점 5점(리뷰 1건).</p><p>메뉴: 최상급 숙성 연어만 사용합니다! 18,000원.</p><p>주차도 된다.</p><p><a href=\"/dinner/jamsil/restaurant/화목\" style=\"color:var(--primary)\">→ 상세 보기</a></p>",
    },
    {
      type: 'h2',
      id: "푸짐회",
    ...
    {
      type: 'body',
      html: "<p>소주 맥주2800원(2,800원)이 대표 메뉴인 <a href=\"/dinner/jamsil/restaurant/푸짐회\">푸짐회</a>. 모듬회, 매운탕 같은 메뉴도 있다.</p><p>그 외에 매운탕 추가시 사리(무료)도 있다.</p><p>예약 가능.</p><p>평점 5점이면 이 동네에서 상위권이다. 리뷰 106건. 국물이 뜨끈해서 해장이나 든든한 한 끼로 괜찮다.</p><p><a href=\"/dinner/jamsil/restaurant/푸짐회\" style=\"color:var(--primary)\">→ 푸짐회 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "1990-아구찜-방이본점",
    ...
    {
      type: 'body',
      html: "<p>살많은 아구찜(1인)(24,000원)이 대표 메뉴인 <a href=\"/dinner/jamsil/restaurant/1990 아구찜 방이본점\">1990 아구찜 방이본점</a>. 살많은 아구찜(소 (2~3인)), 살많은 아구찜(중 (3~4인)) 같은 메뉴도 있다.</p><p>그 외에 살많은 아구찜(대 (4~5인)), 아구찜 스폐셜(소 (2~3인))도 있다.</p><p>예약 가능.</p><p>평점 5점이면 이 동네에서 상위권이다. 리뷰 100건. 국물이 뜨끈해서 해장이나 든든한 한 끼로 괜찮다.</p><p><a href=\"/dinner/jamsil/restaurant/1990 아구찜 방이본점\" style=\"color:var(--primary)\">→ 1990 아구찜 방이본점 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "솔직한우-방이점",
