const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: "<p><a href=\"/dinner/gangnam/restaurant/칠백한우국밥\">칠백한우국밥</a>. 국밥 전문점입니다.</p><p>대표 메뉴는 한우국밥 10,000원, 한우설렁탕 11,000원, 한우뚝배기불고기 12,000원입니다.</p><p>주차도 가능합니다. 예약이 가능합니다.</p><p>국물 베이스가 진한 편이라 단품 한 그릇으로도 충분히 든든합니다.</p><p>방문 후기에서 자주 언급되는 부분은 서비스 쪽입니다.</p><p><a href=\"/dinner/gangnam/restaurant/칠백한우국밥\" style=\"color:var(--primary)\">→ 칠백한우국밥 상세 정보 보기</a></p>",
    },
    {
      type: 'h2',
      id: "이여곰탕-역삼점",
