...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 4 · 리뷰 892건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3 · 리뷰 463건</span>
...
<span style="background:#FFF7E0;color:#92400E;padding:5px 11px;border-radius:6px;font-size:12px;font-weight:600">★ 3.4 · 리뷰 195건</span>
...
<p style="font-size:14.5px;line-height:1.8;color:#1a1a1a;margin:0 0 14px">송파동 32 1층에 자리한 브런치·양식 레스토랑으로, 평점 3.4점·리뷰 195건의 안정 표본을 갖춘 송리단길 데이트 1순위 옵션입니다. "리뷰많음·점심추천·데이트·주차가능" 네 태그가 매칭되어 있고, 송리단길 일대 분위기와 함께 가는 평일 점심·주말 브런치 데이트 동선에 잘 맞습니다. <strong>MIP 브런치 19,000원·에그 베네딕트 19,000원이 점심 메인</strong>이고, 스테이크 에그 베네딕트 26,000원·연어 에그 베네딕트 24,000원으로 고급 브런치 옵션도 함께 운영됩니다. 파스타 라인업(명란 오일 18,000원·투움바 22,000원·스테이크 크림 36,000원)으로 디너 데이트까지 확장 가능합니다.</p>
<div style="background:#FFF7E0;border-left:3px solid #F59E0B;padding:12px 16px;margin:14px 0;border-radius:0 6px 6px 0">
<p style="font-size:12px;color:#92400E;margin:0 0 6px;font-weight:600">📝 방문자 후기 키워드 정리</p>
