const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: "<p>강남역 가성비 맛집을 검색하면 너무 많은 결과가 나옵니다. 285곳의 데이터에서 실제로 방문할 만한 7곳만 선별하였습니다.</p><p>평균 평점 0점입니다. 가격대는 1,500원부터 시작하며, 2026년 5월 기준이며, 1인 가격·양·혼밥 가능 여부을 위주로 비교하였습니다.</p><p>소개 순서: 플랫나인, 고베규카츠 서울 강남점, 미나리밭오리사냥 강남역점, 팔도밀방 강남본점, 정희 강남역점.</p>",
    },
    {
      type: 'toc',
    },
    ...
    {
      type: 'body',
      html: "<p>강남역 전체 285곳에서 가성비 카테고리에 해당하는 식당을 선별하였습니다. 평점 0점 이상, 1인 가격·양·혼밥 가능 여부 기준으로 비교하였습니다. 2026년 5월 데이터 기준이므로, 폐업이나 가격 변동이 있을 수 있으니 방문 전에 반드시 확인하시기 바랍니다.</p>",
    },
    {
      type: 'h2',
      id: "플랫나인",
    ...
    {
      type: 'body',
      html: "<ul><li><strong>가성비 우선:</strong> 플랫나인, 고베규카츠 서울 강남점 — 합리적인 가격에 만족스러운 식사가 가능합니다.</li><li><strong>혼밥:</strong> 고베규카츠 서울 강남점 — 1인 식사가 부담 없는 곳입니다.</li><li><strong>평점 최고:</strong> 플랫나인 (평점 0점) — 방문자 평가가 가장 높습니다.</li><li><strong>리뷰 최다:</strong> 고베규카츠 서울 강남점 (리뷰 13775건) — 가장 많은 방문자가 검증한 식당입니다.</li></ul>",
    },
    {
      type: 'h2',
      id: "tips",
    ...
    {
      type: 'body',
      html: "<ul><li>미나리밭오리사냥 강남역점, 진구곱창 강남역본점은 점심 피크 시간(12시~12시 30분)에 대기가 있을 수 있습니다. 11시 50분 이전에 방문하시는 것을 추천드립니다.</li><li>플랫나인, 미나리밭오리사냥 강남역점은 사전에 예약하고 방문하시는 것이 좋습니다. 특히 주말 저녁에는 예약이 필수입니다.</li><li>주차 가능한 곳: 진구곱창 강남역본점.</li><li>플랫나인, 고베규카츠 서울 강남점 등은 전용 주차장이 없습니다. 대중교통 이용을 권장드립니다.</li><li>가성비가 좋은 곳일수록 점심 웨이팅이 길어지는 경향이 있습니다. 11시 30분~50분 사이에 방문하시면 대기 시간을 줄이실 수 있습니다.</li></ul>",
    },
    {
      type: 'cta',
      href: "/dinner/gangnam/category/budget",
      text: "강남역 가성비 맛집 전체 보기 →",
    },
    {
      type: 'ending',
      html: "<p>2026년 5월 기준 정보입니다. 영업시간이나 가격은 변동될 수 있으므로, 방문 전에 한 번 확인하시는 것을 권장드립니다. 아래 관련 글도 함께 참고해 주시기 바랍니다.</p><ul><li><a href=\"/posts/gangnam-meat-best-2026\">강남역 고기 맛집 추천 7곳</a></li><li><a href=\"/posts/gangnam-date-best-2026\">강남역 데이트 레스토랑 추천 7곳</a></li><li><a href=\"/posts/gangnam-team-dinner-best-2026\">강남역 회식 장소 추천 7곳</a></li><li><a href=\"/posts/gangnam-izakaya-best-2026\">강남역 이자카야·술집 추천 7곳</a></li><li><a href=\"/dinner/gangnam\">강남역 전체 맛집 보기</a></li></ul>",
    }
  ],
}
