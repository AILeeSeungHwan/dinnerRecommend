...
export default function RestaurantPage({ restaurant: r, similar }) {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      { "@type":"Question", "name":`${r.name} 위치(주소)는?`, "acceptedAnswer":{ "@type":"Answer", "text":`서울 송파구 ${r.addr} (잠실 근처)` } },
      ...
      { "@type":"Question", "name":`${r.name} 주차 가능한가요?`, "acceptedAnswer":{ "@type":"Answer", "text":'잠실 인근 공영주차장 또는 코엑스 주차장을 이용하시거나 대중교통을 권장합니다.' } },
    ]
  }
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type":"ListItem", "position":2, "name":"잠실 맛집", "item":"https://gangnamwhat.com/dinner/jamsil" },
      slug && { "@type":"ListItem", "position":3, "name":`잠실 ${catName}`, "item":`https://gangnamwhat.com/dinner/jamsil/category/${slug}` },
