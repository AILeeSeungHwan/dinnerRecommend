...
export default function SamseongPage() {
  ...
  return (
    <Layout title="홍대입구 맛집 AI 추천" description="홍대입구·홍대대로 주변 맛집 AI 추천. 국밥·이자카야·한우·중식 170개+ 식당." canonical="https://dinner.ambitstock.com/dinner/hongdae">
      <Head>
        <title>홍대입구 맛집 추천 | 홍대대로·홍대 AI 추천 | 오늘뭐먹지</title>
        <meta name="description" content="홍대입구 맛집 AI 추천. 4번출구·홍대대로 주변 국밥·이자카야·한우·중식 170개+ 식당." />
