...
export default function SamseongPage() {
  ...
  return (
    <Layout title="수지 맛집 AI 추천" description="수지구청역·풍덕천동·동천동 주변 맛집 AI 추천. 국밥·이자카야·한우·중식 식당." canonical="https://dinner.ambitstock.com/suji">
      <Head>
        <title>수지 맛집 추천 | 수지구청역·풍덕천동 AI 추천 | 오늘뭐먹지</title>
        <meta name="description" content="수지 맛집 AI 추천. 수지구청역·풍덕천동·동천동 주변 국밥·이자카야·한우·중식 식당." />
