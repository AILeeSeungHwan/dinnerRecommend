...
export default function JamsilPage() {
  ...
  return (
    <Layout
      title="망포역 맛집 AI 추천"
      description="망포역·수원 삼성전자·석촌호수 주변 맛집 AI 추천. 곱창·국밥·이자카야·롯데타워 맛집."
      canonical="https://dinner.ambitstock.com/samsungElectronics/mangpo"
    >
      <Head>
        <title>망포역 맛집 추천 | 삼성전자 망포 AI 추천 | 뭐먹지</title>
        <meta name="description" content={`망포역·수원 삼성전자·석촌호수 주변 맛집 AI 추천. 곱창·삼겹살·국밥·이자카야·오마카세 ${restaurants.length}개+ 식당.`} />
