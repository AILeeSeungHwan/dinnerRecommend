...
export default function SamseongPage() {
  ...
  return (
    <Layout title="망포 맛집 AI 추천" description="망포·수원 주변 맛집 AI 추천. 국밥·이자카야·한우·중식 170개+ 식당." canonical="https://dinner.ambitstock.com/samsungElectronics/mangpo">
      <Head>
        <title>망포 맛집 추천 | 망포역·삼성전자 AI 추천 | 오늘뭐먹지</title>
        <meta name="description" content="망포 맛집 AI 추천. 망포역·삼성전자 주변 국밥·이자카야·한우·중식 135개+ 식당." />
